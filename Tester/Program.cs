...
namespace Tester
{
	static class Program
	{
		static void Main()
		{
			...
			// long as the project that it is included in has a reference to "RuntimeSupport". The new class has the namer "Runner" and has a
			...
			var translatedStatements = VBScriptTranslator.CSharpWriter.DefaultTranslator.Translate(
				scriptContent,
