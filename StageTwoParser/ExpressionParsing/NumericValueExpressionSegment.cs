...
{
    public class NumericValueExpressionSegment : IExpressionSegment
    {
        public NumericValueExpressionSegment(NumericValueToken token)
        {
            if (token == null)
        ...
        /// </summary>
        public NumericValueToken Token { get; private set; }
