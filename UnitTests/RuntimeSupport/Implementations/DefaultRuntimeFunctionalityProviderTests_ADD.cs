		...
		public class ADD
		{
			...
			public static IEnumerable<object[]> SuccessData
			{
				get
				{
					...
					// Some COM interop calls will return a System.Runtime.InteropServices.CurrencyWrapper instance and they must be treated the same as a Currency value
					yield return new object[] { "CurrencyWrapper(1.2) + CInt(1)", new CurrencyWrapper(1.2m), (short)1, 2.2m };
