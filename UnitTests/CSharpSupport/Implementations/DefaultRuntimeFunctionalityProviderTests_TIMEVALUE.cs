...
namespace VBScriptTranslator.UnitTests.CSharpSupport.Implementations
{
    public static partial class DefaultRuntimeFunctionalityProviderTests
    {
        public class TIMEVALUE
        {
            ...
            {
                Assert.Equal(expectedResult, DefaultRuntimeSupportClassFactory.Get().TIMEVALUE(value));
            }
            ...
            public void TypeMismatchCases(string description, object value)
            {
                ...
                {
                    DefaultRuntimeSupportClassFactory.Get().TIMEVALUE(value);
                });
            }
            ...
            public static IEnumerable<object[]> SuccessData
            {
                get
                {
                    yield return new object[] { "String \"2009-10-11\"", "2009-10-11", VBScriptConstants.ZeroDate };
                    yield return new object[] { "String \"2009-10-11 20:12:44\"", "2009-10-11 20:12:44", VBScriptConstants.ZeroDate.Add(new TimeSpan(20, 12, 44)) };
                    yield return new object[] { "A Date", new DateTime(2009, 7, 6, 20, 12, 44), VBScriptConstants.ZeroDate.Add(new TimeSpan(20, 12, 44)) };
                    yield return new object[] {
                        "Object with default property which is String \"2009-10-11 20:12:44\"",
                        new exampledefaultpropertytype { result = "2009-10-11 20:12:44" },
                        VBScriptConstants.ZeroDate.Add(new TimeSpan(20, 12, 44))
                    };

                    // Note: We could go to town with test cases for the various string formats that VBScript supports, but the TIMEVALUE implementation backs onto the DateParser and
